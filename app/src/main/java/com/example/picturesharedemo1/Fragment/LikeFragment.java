...
public class LikeFragment extends Fragment {
    ...
    private void init_like() {
        ...
        query_like.addWhereRelatedTo("user_like",new BmobPointer(currentUser));
            ...
            public void done(List<Post> list, BmobException e) {
                if(e==null){
                    ...
                    for(int i=0;i<list.size();i++) {
                        ...
                        Glide.with(getActivity()).load(list.get(i).getImage().getUrl()).placeholder(R.drawable.load_fail)
                            ...
                            public void onClick(View paramView) {
                                ...
                                imgEntryView.setOnLongClickListener(new View.OnLongClickListener() {
                                    ...
                                    public boolean onLongClick(View view) {
                                        ...
                                        builder.setItems(new String[]{"保存图片","取消点赞"}, new DialogInterface.OnClickListener() {
                                            @Override
                    ...
                    //Toast.makeText(getActivity(), "点赞个数"+list.size(), Toast.LENGTH_SHORT).show();
                }
                else{
        ...
        po.update(removeID, new UpdateListener() {
            ...
            public void done(BmobException e) {
                if (e == null) {
                    ...
                    Toast.makeText(getActivity(), "点赞数更新失败", Toast.LENGTH_SHORT).show();
                }
            }
        });
        Post unlike_po = new Post();
        unlike_po.setObjectId(removeID);
